...
class Employee(db.Model):
    ...
    # Relation mapping the employee to related meetings
    meetings = db.relationship('Meeting', secondary=employee_meetings, 
                               back_populates='employees')
    # Relation mapping the employee to related assignments
    assignments = db.relationship('Assignment', back_populates='employee', 
                                  cascade='all, delete-orphan')
    
    # Association proxy to get projects for this employee through assignemnts
...
class Meeting(db.Model):
    ...
    employees = db.relationship('Employee', secondary=employee_meetings, 
...
class Project(db.Model):
    ...
    # Relation mapping the project to related assignments
...
class Assignment(db.Model):
    ...
    # Relation mapping the assignment to related employee
    employee = db.relationship('Employee', back_populates='assignments')
    # Relation mapping the assignemnt to related project
